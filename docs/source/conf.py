...
# add a logo here
#html_logo = "path_to_png.png"

#html_theme = 'pydata_sphinx_theme'
html_theme = "sphinx_book_theme"

html_title = "xcompare - A collection of comparison tools for xarray"

html_context = {
    "github_user": "jkrasting",
    "github_repo": "xcompare",
    "github_version": "main",
    "doc_path": "docs",
}

html_theme_options = dict(
    repository_url="https://github.com/jkrasting/xcompare",
...
main(['-f', '-M', '-e', '-T', '../../src/xcompare', '-o', 'api' ])
